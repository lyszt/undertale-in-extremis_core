...
LocalBP versus BiModeBP em uma carga Monte Carlo}
...
\begin{abstract}
  ...
  engine running 10{,}000 automated matches. The assembly code from the
...
\begin{resumo}
  ...
  10.000 partidas. O código \emph{assembly} do primeiro trabalho foi
...
Monte Carlo de 10.000 partidas entre três estratégias de IA distintas.
...
de decisão no laço das 10.000 partidas.
